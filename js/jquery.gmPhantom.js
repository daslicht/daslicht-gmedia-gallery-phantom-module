	...
	(function($, window, document){
		...
		$.fn.gmPhantom = function(method){
		    ...
		    function Countdown() 
		    {
		        ...
		        this.addTimer = function(container) {
		            var timer = 
			            '<div class="daslicht_slideshow_controls_container" > '+
			            '<div class="progress"></div>'+
			 			'<div title="test" class="toggleSlideshow startTimer" alt=""></div>'+
			            '</div>';
			...
			var Container = this,
				...
				methods = {
					...
					initGallery: function(){// Init the Gallery
						...
						LightboxHTML.push('                </div>');
						LightboxHTML.push('            </div>');
						//LightboxHTML.push('<div class="daslicht_slideshow_controls_container"></div>');
			...
			/*daslicht*/
					...
					showLightbox: function(no){// Show Lightbox
						...
						c.addTimer($(".gmPhantom_LightboxWindow"));
					},
